...
//Login btn implimentation
document.getElementById("login-btn").addEventListener("click", function () {
  document.querySelector(".login").classList.add("active-log");
});

document.querySelector(".close").addEventListener("click", function () {
  document.querySelector(".login").classList.remove("active-log");
});

document.getElementById("signup-btn").addEventListener("click", function () {
  document.querySelector(".signup").classList.add("active-log-signup");
});

document
  .querySelector(".signup .close-sign")
  .addEventListener("click", function () {
    document.querySelector(".signup").classList.remove("active-log-signup");
  });
